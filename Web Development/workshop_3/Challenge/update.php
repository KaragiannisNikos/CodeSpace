...
<div class="container">
    ...
    <form action="update.php" method="post">
        <div class="form-group">
            <label for="item_id">Update Item Name</label>
        ...
        <div class="form-group">
            ...
            <input type="text" name="item_name" class="form-control" required value="<?php if (isset($_POST['item_name'])) echo $_POST['item_name']; ?>">
        </div>
        <div class="form-group">
            <label for="description">Description</label>
            <textarea id="item_desc" class="form-control" name="item_desc" value="<?php if (isset($_POST['item_desc'])) echo $_POST['item_desc']; ?>"></textarea>
        </div>
        <div class="form-group">
            <label for="item_img">Update Item Image</label>
            <input type="text" name="item_img" class="form-control" required value="<?php if (isset($_POST['item_img'])) echo $_POST['item_img']; ?>">
        </div>
        <div class="form-group">
